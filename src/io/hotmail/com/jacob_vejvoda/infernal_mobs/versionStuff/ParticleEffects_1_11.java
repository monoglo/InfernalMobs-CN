...
public enum ParticleEffects_1_11 {
	...
	ParticleEffects_1_11(String name, int id) {
		this.name = name;
		this.id = id;
	}
	 ...
	 */
	public static void sendToPlayer(ParticleEffects_1_11 effect, Player player, Location location, float offsetX, float offsetY,
	 ...
	 *            The count of effects
	 */
	public static void sendToLocation(ParticleEffects_1_11 effect, Location location, float offsetX, float offsetY, float offsetZ, float speed, int count) {
		try {
			Object packet = createPacket(effect, location, offsetX, offsetY, offsetZ, speed, count);
	...
	private static Object createPacket(ParticleEffects_1_11 effect, Location location, float offsetX, float offsetY,
